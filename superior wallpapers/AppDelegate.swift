...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        storeKitHelper.incrementNumerOfTimesLaunched()
    ...
    private func setupGlidingCollection() {
        ...
        config.activeButtonColor = UIColor.white
        config.cardShadowColor = UIColor.black
        config.cardsSize = CGSize.init(width: 285, height: 465)
