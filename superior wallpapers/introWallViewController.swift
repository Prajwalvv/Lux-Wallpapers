//
//  introWallViewController.swift
//  superior wallpapers
//
//  Created by splash on 17/05/19.
...
//    let UrlPathString = Bundle.main.path(forResource: "intro", ofType: "mp4")
    
    
    let cellId = "cellId"
    
    let pages: [Page] = {
        let firstPage = Page(title: "App Walkthrough", message: "Just click on the image to save,  in order to set it as the wallpaper for your device", imageName: "help")
